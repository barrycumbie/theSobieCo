...
app.get('/', async function (req, res) {
  ...
  res.render('manage-profile/profile',{profileData:results});
})
//*********************************************** */
// Create profile
app.get('/create-profile', (req, res) => {
  res.render('manage-profile/create-profile',{message: null});  
});
app.post('/create-profile', async (req, res) => {
  ...
  if (!firstname || !lastname || !email || !phone || !birthdate || !gender) {
    return res.render('manage-profile/create-profile', { message: 'Please fill in all required fields.' });
  }
  ...
  try {
    ...
    console.error(err);
    res.render('manage-profile/create-profile', { message: 'Error saving profile. Please try again.' });
  }
});
//****************************************************** */
//Welcome screen
app.get('/welcome', async (req, res) => {
  try {
    ...
    res.render('manage-profile/welcome', { profile, registration });
  } catch (err) {
    console.error(err);
...
app.get('/edit-profile', async (req, res) => {
  ...
  try {
    ...
    res.render('manage-profile/edit-profile', { profile, message: null });
  } catch (err) {
